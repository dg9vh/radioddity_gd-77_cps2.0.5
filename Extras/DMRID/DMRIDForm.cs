...
namespace DMR
{
	public partial class DMRIDForm : Form
	{
		...
		{
			SortableBindingList<DMRDataItem> bindingList = new SortableBindingList<DMRDataItem>(DataList);
	...
	public class SortableBindingList<T> : BindingList<T> where T : class
	{
		...
		private int OnComparison(T lhs, T rhs)
		{
			...
			// HACK ALERT. Always use the Age 
			lhsValue = (lhs as DMRDataItem).AgeAsInt;
			rhsValue = (rhs as DMRDataItem).AgeAsInt;
